...
![](https://github.com/juvelas/juvelas.github.io/blob/master/blog1_fig1.jpg?raw=true?classes=caption,figure-left,caption-right "Figura 1. Distribución de especies en peligro crítico de extinción en la región central de los Andes de Colombia (en rojo). En verde están identificadas las áreas protegidas de nivel nacional y regional para esa región")
